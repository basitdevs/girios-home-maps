  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='relative max-w-[1346px] mx-auto overflow-hidden'>
        ...
        {/* Top left text */}
        <div className='absolute z-[10] flex w-full h-fit justify-between lg:px-[55px] top-auto bottom-[14px] md:top-[50px] px-[20px]'>
      ...
      {/* Banner Bottom */}
      <div className='min-h-[83.812px] max-w-[1346px] translate-y-[-1px] flex md:flex-row flex-col items-center justify-between px-[20px] md:px-[35px] py-[30px] md:py-[10px] mx-auto overflow-hidden w-full bg-black  relative z-10 md:rounded-b-[6px]'>
        ...
        <ul className='flex md:hidden items-center justify-between gap-[10px] w-full'>
          {bannerDetails.slice(0, 2).map(({ label, value }, idx) => (
            <li key={idx} className='text-quinary flex items-center gap-[5px]'>
              <span className='uppercase text-[13px] font-[400] leading-[31px] tracking-[1.3px]'>
                {label}
              </span>
              <span className='bg-[#FAFAFA] h-[1px] w-[9.28px]'></span>
              <span className='text-[15px] md:text-[18px] font-[600] leading-[31px] tracking-[-0.306px]'>
                {value}
              </span>
            </li>
          ))}
